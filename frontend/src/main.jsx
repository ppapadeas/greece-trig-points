...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: 300, letterSpacing: '-0.02em' },
    h2: { fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: 300, letterSpacing: '-0.02em' },
    h3: { fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: 300, letterSpacing: '-0.02em' },
    h4: { fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: 300, letterSpacing: '-0.02em' },
    h5: { fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: 300, letterSpacing: '-0.02em' },
    h6: { fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: 300, letterSpacing: '-0.02em' },
